...
namespace ffbeApi.Controllers.V1
{
    ...
    public class EnhancementsController : Controller
    {
        ...
        {
            var enhancements = _ffbeContext.Enhancements;
            return new ListObjectResult(enhancements) { ListName = nameof(enhancements) };
        }

        [HttpGet("{id:int}")]
        public IActionResult GetByID(int id)
        {
            var unit = _ffbeContext.Enhancements.SingleOrDefault(m => m.Id == id);
        ...
        {
            var unit = _ffbeContext.Enhancements
