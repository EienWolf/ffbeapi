...
namespace ffbeApi.Controllers.V1
{
    ...
    public class RegionsController : Controller
    {
        ...
        {
            var Regions = _ffbeContext.Regions;
            return new ListObjectResult(Regions) { ListName = nameof(Regions) };
        }

        [HttpGet("{id:int}")]
        public IActionResult GetByID(int id)
        {
            var unit = _ffbeContext.Regions.SingleOrDefault(m => m.Id == id);
