...
namespace ffbeApi.Controllers.V1
{
    ...
    public class RecipesController : Controller
    {
        ...
        {
            var Recipes = _ffbeContext.Recipes;
            return new ListObjectResult(Recipes) { ListName = nameof(Recipes) };
        }

        [HttpGet("{id:int}")]
        public IActionResult GetByID(int id)
        {
            var unit = _ffbeContext.Recipes.SingleOrDefault(m => m.Id == id);
