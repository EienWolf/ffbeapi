...
namespace ffbeApi.Controllers.V1
{
    ...
    public class MateriasController : Controller
    {
        ...
        {
            var Materias = _ffbeContext.Materias;
            return new ListObjectResult(Materias) { ListName = nameof(Materias) };
        }

        [HttpGet("{id:int}")]
        public IActionResult GetByID(int id)
        {
            var unit = _ffbeContext.Materias.SingleOrDefault(m => m.Id == id);
        ...
        {
            var unit = _ffbeContext.Materias
